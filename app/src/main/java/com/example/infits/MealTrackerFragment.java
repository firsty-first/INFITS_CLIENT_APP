...
public class MealTrackerFragment extends Fragment {
    ...
    List<addmealInfo_meal_tracker> addmealInfos;
    View bottomSheetN;
    RequestQueue queue;
            ...
            if(!response.toString().equals("0 results"))
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        addmealInfo_meal_tracker mealarr = new addmealInfo_meal_tracker(R.drawable.donutimg_mealtracker,meal,name,calorie,carb,protein,fat);
