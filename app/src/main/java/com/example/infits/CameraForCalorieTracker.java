...
public class CameraForCalorieTracker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_for_calorie_tracker);
        ...
        saveImageButton.setOnClickListener(v -> {
            try {
                ...
                Log.d("Meal_tyepe",Meal_Type.toString());
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(CameraForCalorieTracker.this, android.Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSourceFlash.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(CameraForCalorieTracker.this, new
