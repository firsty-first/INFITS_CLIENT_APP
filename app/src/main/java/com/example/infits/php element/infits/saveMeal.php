...
function addMeal($conn, $row_id,$mealchart_id,$client_id,$dietitian_id,$clientuserID,$dietitianuserID,$currentDay,$name,$meal,$Calories,$carbs ,$fiber,$protein ,$fat,$position ,$dateandtime,$filename,$description){
...
if ($stmt) {
  $stmt->bind_param("iiiissssssiiiiisss", $row_id,$mealchart_id,$client_id,$dietitian_id,$clientuserID,$dietitianuserID,$currentDay,$name,$meal,$Calories,$carbs ,$fiber,$protein ,$fat,$position ,$dateandtime,$filename,$description);
  $result = $stmt->execute();
...
addMeal($conn, $row_id, $mealchart_id, $client_id, $dietitian_id, $clientuserID, $dietitianuserID, $currentDay, $name, $meal, $Calories, $carbs, $fiber, $protein, $fat, $position, $dateandtime, $filename, $description);
